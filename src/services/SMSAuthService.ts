...
class SMSAuthService {
   ...
   * @param phoneNumber - Phone number in format +57XXXXXXXXXX
  ...
  private isValidPhoneNumber(phoneNumber: string): boolean {
    // Colombian phone number validation - more flexible
    const cleaned = phoneNumber.replace(/\D/g, '');
    
    // Accept formats: 3XXXXXXXXX (10 digits) or 573XXXXXXXXX (12 digits)
